...
from MCTS_temp import MCTS as MCTSSearcher
from MCTS_temp import play_with_MCTS
...
if __name__=='__main__':
    ...
    opponents = {
        ...
        'mcts_RAN': MCTSSearcher(policy_network=RandomNetwork(), random_network=RandomNetwork(), seconds_per_move=SEARCH_TIME),
    ...
    for oppo in opponents:
        for policy_network in policynetworks:
            model_1 = MCTSSearcher(
                        policy_network=policynetworks[policy_network],
                        random_network=RandomNetwork(),
                        seconds_per_move=SEARCH_TIME)
            model_2 = opponents[oppo]

            print "Black:", policy_network, "v.s. White:", oppo
            match_set(model_1, model_2, "black")

            print "Black:", oppo, "v.s. White:", policy_network
