		...
		for line in file.readlines():
			...
			if line_cnt > 24:
				...
				if black_move != '--':
					...
					output.write('1 ' + str(ord(black_move[0]) - 97) + ' ' + str(8 - int(black_move[1])) +' '+str(black_score)+'\n')
				...
				if white_move != '--':
					...
					output.write('0 ' + str(ord(white_move[0]) - 97) + ' ' + str(8 - int(white_move[1])) +' '+str(white_score)+'\n')
