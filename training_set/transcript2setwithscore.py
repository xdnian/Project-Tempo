...
for filepath in glob.glob(DATA_DIR+'*.txt'):
    ...
    try:
        ...
        try:
            ...
            # black tech - new, if win/loss appears in 57&58, get scores from 53&54 moves instead
            target = linecache.getline(filepath, 51)
            black_s, white_s = target[8:15], target[45:52]
            linecache.clearcache()
        ...
        for line in inputfile.readlines():
            ...
            if line_cnt > 24:
                ...
                white_cnt, white_move, white_score_s = line[38:40], line[42:44], line[45:53]
                ...
                if white_score_s.strip():
                    if white_score_s == 'Win     ':
                        ...
                        try:
                            ...
                            white_score = float(white_score_s[1:])
                else:
                    if line_cnt < 50:
                        # white_score = 100
                        white_score = white_standard
